  ...
  const onSubmit = async (e) => {
    ...
    if (!isSigningIn) {
      ...
      try {
        ...
        // doSendEmailVerification(); // Uncomment to send verification email
      } catch (error) {
                ...
                <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-lg">
                    ...
                    >
                        ...
                        <button
                            ...
                            className={`w-full py-2 px-4 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition duration-300 ${isSigningIn ? 'opacity-50 cursor-not-allowed' : ''}`}
                        >
