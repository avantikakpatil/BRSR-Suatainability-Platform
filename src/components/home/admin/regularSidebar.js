...
import { FaUser, FaChartLine, FaTasks, FaTrophy, FaDatabase, FaChartPie } from "react-icons/fa";

const RegularSidebar = ({ onLeaderboardClick, onChallengesClick, onInputDataClick}) => {
